...
function HttpSendRequest($http) {
    ...
    $http({
      ...
      .then(function onSuccess(response) {
        ...
        // ダミーデータを用意
        var data = JSON.parse("{\"1\":{\"disg\":{\"1\":{\"dx\":0.0016007795272043844,\"dy\":0.029759331955570335,\"dz\":0.009600811021961215,\"rx\":-0.0041371395313586495,\"ry\":0.00024312047786018395,\"rz\":0.001167513721872656},\"2\":{\"dx\":0.0014800710974349491,\"dy\":0.03694158759025001,\"dz\":0.009600811021961215,\"rx\":-0.0041371395313586495,\"ry\":0.00024312047786018395,\"rz\":0.001167513721872656}},\"fsec\":{\"1\":{\"n\":1.1111,\"np\":0.1111,\"fx\":0.009600811021961215,\"fy\":-0.0041371395313586495,\"fz\":0.00024312047786018395,\"mx\":0.001167513721872656,\"my\":0.001167513721872656,\"mz\":0.001167513721872656},\"2\":{\"n\":0.2222,\"np\":0.2222,\"fx\":0.009600811021961215,\"fy\":-0.0041371395313586495,\"fz\":0.00024312047786018395,\"mx\":0.001167513721872656,\"my\":0.001167513721872656,\"mz\":0.001167513721872656}},\"reac\":{\"1\":{\"rx\":0.0016007795272043844,\"ry\":0.029759331955570335,\"rz\":0.009600811021961215,\"mx\":0.001167513721872656,\"my\":0.001167513721872656,\"mz\":0.001167513721872656},\"2\":{\"rx\":0.0016007795272043844,\"ry\":0.029759331955570335,\"rz\":0.009600811021961215,\"mx\":0.001167513721872656,\"my\":0.001167513721872656,\"mz\":0.001167513721872656}}}}");
        console.log(data);

        // 計算結果を保持させる
        var element = document.getElementById('popupConfigElement');
        var scope = angular.element(element).scope();
        scope.keepCulcResult(data);
